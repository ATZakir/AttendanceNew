...
namespace Attendance.Service
{
    public interface IWorkflowactionSettingService
    {
        ...
        bool CheckUserInWorkflowactionSettingForUrl(string urlPath, int employeeId, int workflowactionId);
    ...
    public class WorkflowactionSettingService : IWorkflowactionSettingService
    {
        ...
        {
            return workflowactionSettingRepository.GetMany(ap => ap.EmployeeId.Equals(employeeId)  && ap.WorkflowactionId == workflowaction);
        }
        ...
        public bool CheckUserInWorkflowactionSettingForUrl(string urlPath, int employeeId, int workflowactionId)
        {
            var workflowactionSettingObj = this.workflowactionSettingRepository.Get(ap => ap.SubModuleItem.UrlPath == urlPath && ap.WorkflowactionId == workflowactionId && ap.EmployeeId.Equals(employeeId));
